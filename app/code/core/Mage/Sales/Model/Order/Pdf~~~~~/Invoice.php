...
class Mage_Sales_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Abstract
{
    ...
    public function getPdf($invoices = array())
    {
        ...
        /* $page->setFillColor(Zend_Pdf_Color_Html::color('#000000'))->drawText($IncludedTax, 530, ($this->y), 'UTF-8');
         ...
         $page->setFillColor(Zend_Pdf_Color_Html::color('#646869'))->drawText("We hereby certify that our registration certificate under the Haryana Value Added Tax Act is in force on which  ", 35, ($this->y-20), 'UTF-8');
         $page->setFillColor(Zend_Pdf_Color_Html::color('#646869'))->drawText("the sale of the goods specified in this Tax Invoice has been effected by us and it shall be accounted for in the  ", 35, ($this->y-30), 'UTF-8');
         $page->setFillColor(Zend_Pdf_Color_Html::color('#646869'))->drawText("turnover of sales while filling of return and due tax if any, payable on the sale has been paid or shall be paid.", 35, ($this->y-40), 'UTF-8');
