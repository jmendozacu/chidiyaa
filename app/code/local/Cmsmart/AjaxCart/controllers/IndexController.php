...
try
{
			...
			<ul class="messages ajaxcart-messages">
				<li class="success-msg">
					<ul>
						...
						<li><button onclick="setLocation(\''.Mage::getBaseUrl().'checkout/cart/\')" class="button btn-continue" title="'.$this->__('Checkout').'" type="button"><span><span>'.$this->__('View Cart').'</span></span></button>
						<button onclick="setLocation(\''.Mage::getBaseUrl().'\')" class="button btn-continue" title="'.$this->__('Checkout').'" type="button"><span><span>'.$this->__('Continue Shopping').'</span></span></button>
					</ul>
				</li>
			</ul>
		</div>';
		...
		<div>
			<ul class="messages ajaxcart-messages">
				<li class="success-msg">
					<ul>
						<li><span><a title="'.@$product->getName().'" href="'.@$product->getProductUrl().'">'.@$product->getName().' </a> '.$this->__('Requested Quantity Not Available').'.</span></li>
						<li><button onclick="setLocation(\''.Mage::getBaseUrl().'/\')" class="button btn-continue" title="'.$this->__('Chidiyaa').'" type="button"><span><span>'.$this->__('Continue Shopping').'</span></span></button>
					</ul>
				</li>
			</ul>
		</div>';
