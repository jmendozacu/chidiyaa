...
/**
 * Modified magento class to parse comma separated store_ids
 */
class TM_Crawler_Block_Adminhtml_Widget_Grid_Column_Renderer_Store
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Store
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $origStores = explode(',', $origStores); // modification 1
    ...
    public function renderExport(Varien_Object $row)
    {
        ...
        $skipAllStoresLabel = $this->_getShowAllStoresLabelFlag();
        $origStores = $row->getData($this->getColumn()->getIndex());
        $origStores = explode(',', $origStores); // modification 2
