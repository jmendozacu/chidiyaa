...
$customOverride = Mage::getStoreConfig('tax/custom_tax_calc/active');
$includeTax =  Mage::getStoreConfig('tax/cart_display/grandtotal');
 if($customOverride==1 and $includeTax==1){
