<?php 
class Softprodigy_Pmcm_Model_Express_Checkout extends   Mage_Paypal_Model_Express_Checkout{
	 ...
	 public function start($returnUrl, $cancelUrl, $button = null)
    {
        ...
        $solutionType = $this->_config->getMerchantCountry() == 'DE'
         ...
         $amount = Mage::helper('pmcm')->getExchangeRate($this->_quote->getBaseGrandTotal());
         $this->_api->setAmount($amount)
             //->setCurrencyCode($this->_quote->getBaseCurrencyCode())
             ->setCurrencyCode(Mage::helper('pmcm')->getToCurrency())
