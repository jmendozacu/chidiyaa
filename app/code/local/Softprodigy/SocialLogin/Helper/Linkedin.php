...
class SoftProdigy_SocialLogin_Helper_Linkedin extends Mage_Core_Helper_Abstract
{
    ...
    public function disconnect(Mage_Customer_Model_Customer $customer) {
        ...
        $pictureFilename = Mage::getBaseDir(Mage_Core_Model_Store::URL_TYPE_MEDIA)
            ...
            .'linkedin'
            .DS
            .$customer->getsoftprodigySocialloginLid();

        if(file_exists($pictureFilename)) {
            @unlink($pictureFilename);
        }

            $customer->setsoftprodigySocialloginLid(null)
            ->setsoftprodigySocialloginLtoken(null)
            ->save();
    }
    ...
    public function connectByLinkedinId(
        ...
        $token)
    {
        $customer->setsoftprodigySocialloginLid($linkedinId)
            ->setsoftprodigySocialloginLtoken($token)
            ->save();
        ...
        $token)
    {
        ...
        $customer->setEmail($email)
            ...
            ->setsoftprodigySocialloginLid($linkedinId)
            ->setsoftprodigySocialloginLtoken($token)
    ...
    public function getCustomersByLinkedinId($linkedinId)
    {
        ...
        $collection = $customer->getCollection()
            ->addAttributeToFilter('softprodigy_sociallogin_lid', $linkedinId)
            ->setPageSize(1);
