...
class SoftProdigy_SocialLogin_Model_Linkedin_Client
{
    const REDIRECT_URI_ROUTE = 'softprodigy_sociallogin/linkedin/connect';

    const XML_PATH_ENABLED = 'softprodigy_sociallogin/linkedin/enabled';
    const XML_PATH_CLIENT_ID = 'softprodigy_sociallogin/linkedin/api_key';
    const XML_PATH_CLIENT_SECRET = 'softprodigy_sociallogin/linkedin/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new SoftProdigy_SocialLogin_LinkedinOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('softprodigy_sociallogin')
...
class SoftProdigy_SocialLogin_LinkedinOAuthException extends Exception
{}
