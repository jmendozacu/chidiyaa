...
class SoftProdigy_SocialLogin_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'softprodigy_sociallogin/google/connect';

    const XML_PATH_ENABLED = 'softprodigy_sociallogin/google/enabled';
    const XML_PATH_CLIENT_ID = 'softprodigy_sociallogin/google/api_key';
    const XML_PATH_CLIENT_SECRET = 'softprodigy_sociallogin/google/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new SoftProdigy_SocialLogin_GoogleOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('softprodigy_sociallogin')
...
class SoftProdigy_SocialLogin_GoogleOAuthException extends Exception
{}
