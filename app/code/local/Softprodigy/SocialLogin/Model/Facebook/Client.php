...
class SoftProdigy_SocialLogin_Model_Facebook_Client
{
    const REDIRECT_URI_ROUTE = 'softprodigy_sociallogin/facebook/connect';

    const XML_PATH_ENABLED = 'softprodigy_sociallogin/facebook/enabled';
    const XML_PATH_CLIENT_ID = 'softprodigy_sociallogin/facebook/api_key';
    const XML_PATH_CLIENT_SECRET = 'softprodigy_sociallogin/facebook/secret';
    ...
    protected function _httpRequest($url, $method = 'GET', $params = array())
    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                throw new SoftProdigy_SocialLogin_FacebookOAuthException($message);
            } else {
                $message = sprintf(
                    Mage::helper('softprodigy_sociallogin')
...
class SoftProdigy_SocialLogin_FacebookOAuthException extends Exception
{}
