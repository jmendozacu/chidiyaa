...
class Softprodigy_Message_Block_Adminhtml_Email_Edit2 extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
       return Mage::helper('message')->__("Send Email To Customers");
    }
