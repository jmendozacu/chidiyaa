<?php
class Softprodigy_Message_Block_Adminhtml_Message_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
...
protected function _prepareCollection()
	{
       ...
       $collection = Mage::getResourceModel('customer/customer_collection')
					...
					->joinAttribute('billing_country_id', 'customer_address/country_id', 'default_billing', null, 'left')->addAttributeToFilter('billing_telephone', array('notnull' => true), 'left');
    	 ...
    	 protected function _prepareColumns()
	 {
        ...
        'actions'  => array(
            array(
                'url'     => $link,
                'caption' => $this->helper('adminhtml')->__('Send SMS'),
            ),
        )
    ));
	...
	protected function _prepareMassaction()
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             'label'=> Mage::helper('message')->__('send message'),
