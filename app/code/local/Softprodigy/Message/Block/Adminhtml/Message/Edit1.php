...
class Softprodigy_Message_Block_Adminhtml_Message_Edit1 extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
       return Mage::helper('message')->__("Send SMS To Customer");
    }
