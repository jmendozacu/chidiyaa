 ...
 */
class Softprodigy_MagtrackApi_Model_Mysql4_Bestsellers_Monthly extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {
        $this->_init('softprodigy_magtrackapi/bestsellers_monthly', 'id');
    }
}
