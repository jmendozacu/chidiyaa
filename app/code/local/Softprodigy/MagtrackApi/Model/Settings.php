...
/**
 * MagtrackApi Settings Model
 * 
 * @category    SoftProdigy
 * @package     SoftProdigy_MagtrackApi
 * @author      SoftProdigy Developer
 */
class Softprodigy_MagtrackApi_Model_Settings extends Mage_Core_Model_Abstract
{
    const _SETTING_PATH = 'softprodigy_magtrackapi/setting';
