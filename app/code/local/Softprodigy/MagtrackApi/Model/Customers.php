...
/**
 * MagtrackApi Customers Model
 * 
 * @category    Softprodigy
 * @package     Softprodigy_MagtrackApi
 * @author      Softprodigy Developer
 */
class Softprodigy_MagtrackApi_Model_Customers extends Softprodigy_MagtrackApi_Model_Api_Abstract
{
    /*
     * get customer list
     */
    public function getCustomers($filter = '', $page = 1, $limit = 10, $top = '', $slice = ''){
        Mage::helper('softprodigy_magtrackapi')->setLimit($limit);//reset limit
        ...
        $collection->getSelect()
            ...
            ->limit(Mage::helper('softprodigy_magtrackapi')->getLimit(),
                $page * Mage::helper('softprodigy_magtrackapi')->getLimit())//limit page
...
//        $fromDate = Mage::helper('softprodigy_magtrackapi')->timeBestsellers();
...
//                ));
    ...
    public function getNewCustomer(){
        $lastTime = Mage::helper('softprodigy_magtrackapi')->getTimeNewCustomers();
        $collection = Mage::getModel('customer/customer')->getCollection();
        //collec new customer
        $collection->getSelect()
