...
class Youama_Ajaxlogin_AjaxController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        if (isset($_POST['ajax'])){
            ...
            // Register First Step request
            } else if ($_POST['ajax'] == 'registerfirst' && Mage::helper('customer')->isLoggedIn() != true) {
                $register = Mage::getSingleton('youama_ajaxlogin/ajaxregisterfirst');
                echo $register->getResult();
            }
        }
    }
