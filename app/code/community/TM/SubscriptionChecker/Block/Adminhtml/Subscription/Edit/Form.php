...
class TM_SubscriptionChecker_Block_Adminhtml_Subscription_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('subscription_form');
        $this->setTitle(Mage::helper('subscriptionchecker')->__('Subscription Key'));
    }
